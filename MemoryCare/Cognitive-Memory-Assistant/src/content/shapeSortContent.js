...
const SHAPE_INSTRUCTIONS = {
  ...
  square: { 
    ...
    brx: "सबाथे चौखाफोरखौ खेबो" 
  },
  triangle: { 
    en: "Tap all the triangles", 
    hi: "सभी त्रिभुज छुएँ", 
    as: "সকলো ত্ৰিভুজ স্পৰ্শ কৰক", 
    bn: "सব ত্রিভুজগুলো স্পর্শ করুন", 
    mni: "ত্রিকোণ পুম্নমক নাম্মু",
    brx: "सबाथे त्रिभुजफोरखौ खेबो" 
  },
rectangle: { 
    ...
    mni: "आयत पुम्नमक নাম्मु",
    brx: "सबाथे आयतफोरखौ खेबो" 
  },
  star: { 
...
export function instructionTextFor(target, lang) {
  return instructionFor(target, lang);
}